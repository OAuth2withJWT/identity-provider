...
func (s *Server) setupRoutes() {
	...
	s.router.HandleFunc("/verification", s.handleVerificationPage).Methods("GET")
	...
	s.router.HandleFunc("/request-email-verification", s.handleEnterEmailPage).Methods("GET")
	s.router.HandleFunc("/request-email-verification", s.handleEnterEmailForm).Methods("POST")
	s.router.HandleFunc("/account-status-message", s.handleMessage).Methods("GET")
}
